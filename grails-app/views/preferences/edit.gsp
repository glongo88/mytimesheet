...
<html>
	...
	<body>
		<a href="#edit-preferences" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-preferences" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:preferencesInstance, action:'update']" method="PUT" >
