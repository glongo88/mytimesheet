        ...
        <div class="row">
            ...
            <div class="col-xs-4 ui-248">
                <div class="item">
                    ...
                    <div class="category-title-box-index"><h3><a style="margin-top: 3px;" href="#">Tot. Settimana</a></h3></div>
            ...
            <div class="col-xs-4 ui-248">
                <div class="item">
                    ...
                    <div class="category-title-box-index"><h3><a style="margin-top: 3px;" href="#">Tot. Mese</a></h3></div>
            ...
            <div class="col-xs-4 ui-248">
                <div class="item">
                    ...
                    <div class="category-title-box-index"><h3><a style="color:margin-top: 3px;" href="#">Straordinari</a></h3></div>
